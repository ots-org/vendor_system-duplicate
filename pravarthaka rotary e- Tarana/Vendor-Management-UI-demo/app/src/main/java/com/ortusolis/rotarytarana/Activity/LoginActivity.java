            ...
            public void notifySuccess(String response, int statusCode) {
                try {
                    ...
                    if (responseData.getResponseCode().equalsIgnoreCase("200")) {
                        ...
                        if(responseData.getResponseData().getUserDetails().getUserRoleId().equals("5") ||responseData.getResponseData().getUserDetails().getUserRoleId().equals("3") ||responseData.getResponseData().getUserDetails().getUserRoleId().equals("2") ||responseData.getResponseData().getUserDetails().getUserRoleId().equals("1")){
