...
public class OTSOrder_WsImpl implements OTSOrder_Ws{
	...
	@Scheduled(cron = "0 0 1 * * *",zone = "Indian/Maldives")
	...
	@Override
	public Response getOrderForFacilitator(GetOrderForFacilitatorRequest getOrderForFacilitatorRequest) {
		Response response = null;
		response = buildResponse(oTSOrderService.getUserByStatuesAndDistributorId(getOrderForFacilitatorRequest),"Successful");
		return response;
	}

	@Override
	public Response updateOrderForFacilitator(UpdateOrderdProductRequest updateOrderdProductRequest) {
		Response response = null;
		response = buildResponse(oTSOrderService.updateOrderdProductStatus(updateOrderdProductRequest),"Successful");
		return response;
	}
}
