...
public interface OTSOrder_Ws {
	...
	@POST
    @Path("/getOrderForFacilitator")
	@ApiOperation(value = "getOrder", notes = "get order details for orderId", response = Response.class)
	@ApiResponses(value = { @ApiResponse(code = 0, message = "SUCCESS") })
	Response getOrderForFacilitator(GetOrderForFacilitatorRequest  getOrderForFacilitatorRequest);
	
	@POST
    @Path("/updateOrderForFacilitator")
	@ApiOperation(value = "getOrder", notes = "get order details for orderId", response = Response.class)
	@ApiResponses(value = { @ApiResponse(code = 0, message = "SUCCESS") })
	Response updateOrderForFacilitator(UpdateOrderdProductRequest  updateOrderdProductRequest);
}
