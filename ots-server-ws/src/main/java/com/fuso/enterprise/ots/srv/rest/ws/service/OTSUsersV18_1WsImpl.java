...
//		}
	...
	@Override
	public Response getSellerByLatAndLon(GetSellerByLatAndLonRequest getSellerByLatAndLonRequest) {
		Response response = null;
		try {
			response = buildResponse(otsUserService.getSellerDetails(getSellerByLatAndLonRequest),"success");
		}catch(Exception e){
			System.out.print(e);
		}
		return response;
