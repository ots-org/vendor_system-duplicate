...
public interface OTSUsersV18_1Ws {
	...
	@ApiOperation(value = "getUserDetails", notes = "Validate UserName and Password", response = Response.class)
	@ApiResponses(value = { @ApiResponse(code = 0, message = "SUCCESS") })
	Response LoginAuthentication(@ApiParam(value = "request", required = true) @NotNull  @Valid LoginAuthenticationRequest  loginAuthenticationRequest);		
