...
public interface OTSUsersV18_1Ws {
	...
	@ApiOperation(value = "getCustomerDetailsForLogin", notes = "This operation will getCustomerDetailsForLogin", response = Response.class)
	@ApiResponses(value = { @ApiResponse(code = 0, message = "SUCCESS") })
	...
	@POST
	@Path("/getSellerByLatAndLon")
	@ApiOperation(value = "GetSellerByLatAndLonRequest", notes = "This operation will get seller for order", response = Response.class)
	@ApiResponses(value = { @ApiResponse(code = 0, message = "SUCCESS") })
	Response getSellerByLatAndLon(@ApiParam(value = "request", required = true) @NotNull @Valid GetSellerByLatAndLonRequest getSellerByLatAndLonRequest);
