...
import com.ortusolis.etaaranavkf.BuildConfig
...
import com.ortusolis.etaaranavkf.Utility.CommonFunctions
import com.ortusolis.etaaranavkf.Utility.NotificationUtils
import com.ortusolis.etaaranavkf.app.Config
import com.ortusolis.etaaranavkf.fragment.NavigationFragment
import com.ortusolis.etaaranavkf.fragment.NotificationFragment
import com.ortusolis.etaaranavkf.fragment.ProductsFragment
import com.ortusolis.etaaranavkf.location.LocationRequestHelper
import com.ortusolis.etaaranavkf.location.LocationUpdatesBroadcastReceiver
import com.ortusolis.etaaranavkf.pojo.LoginResponse
...
GoogleApiClient.OnConnectionFailedListener {
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        if (sharedPreferences?.contains("userRoleId")!! && (!sharedPreferences?.getString("userRoleId", "")!!.equals("1", ignoreCase = true)&&!sharedPreferences?.getString("userRoleId", "")!!.equals("2", ignoreCase = true)&&!sharedPreferences?.getString("userRoleId", "")!!.equals("3", ignoreCase = true))) {
