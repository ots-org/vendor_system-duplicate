...
import com.ortusolis.evenkart.adapter.DonationAdapter;
import com.ortusolis.evenkart.service.RazorPayActivity;
...
public class DonationActivity extends AppCompatActivity implements Serializable {
    ...
    boolean validate(){
        ...
        if (donarAmount.getText().toString().isEmpty()){
            ...
            donarName.setError("Customer Name cannot be empty ");
            valid = false;
        }
