...
import com.ortusolis.rotarytaranaadmin.adapter.CartListAdapter;
...
//                                    }
    ...
    ProductRequest prepareOrder(List<ProductRequestCart> productRequestCartList){
        ...
        for (ProductRequestCart productRequestCart : productRequestCartList) {
            ...
            totalBaseCost = (Float.valueOf(productRequestCart.getOrderedQty()) * Float.valueOf(productRequestCart.getBasePrice())) + totalBaseCost;
            totalAmountPayment=totalCost;
        }
        requestS.setOrderCost((String.format("%.02f", totalCost))+"");
        requestS.setBasePrice((String.format("%.02f", totalBaseCost))+"");
