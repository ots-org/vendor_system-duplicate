...
import com.ortusolis.rotarytaranaadmin.pojo.ProductDetails;
import com.ortusolis.rotarytaranaadmin.pojo.ProductRequest;
import com.ortusolis.rotarytaranaadmin.pojo.ProductRequestCart;
import com.ortusolis.rotarytaranaadmin.pojo.ProductsStock;
import com.ortusolis.rotarytaranaadmin.pojo.UserInfo;
import com.ortusolis.rotarytaranaadmin.service.RazorPayActivity;
...
//            customerStrName = sharedPreferences.getString("username","");
    ...
    void scheduleDays(){
     ...
     void setValues(){
         ...
         basePrice=Float.valueOf(productDetails.getProductBasePrice());
    ...
    void insertOrderAndProducttoCart(){
        ...
        if (distributorStr != null && customerStr != null ) {//&& selectDateStr!=null
            ...
            if (TextUtils.isEmpty(sharedPreferences.getString("prodDesc",""))) {
                ...
                requestS.setBasePrice((basePrice * quant)+"");
