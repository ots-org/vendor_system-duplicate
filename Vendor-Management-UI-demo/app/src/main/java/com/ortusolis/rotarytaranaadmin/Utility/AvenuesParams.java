package com.ortusolis.rotarytaranaadmin.Utility;
...
public class AvenuesParams{
    ...
    public static final String ACCESS_CODE = "AVVM67DI04BP90MVPB";
    public static final String MERCHANT_ID = "265087";
    ...
    public static final String CANCEL_URL = "https://test.ccavenue.com/transaction/transaction.do";
    ...
    public static final String RSA_KEY_URL = "https://test.ccavenue.com/transaction/transaction.do?command=initiateTransaction";
