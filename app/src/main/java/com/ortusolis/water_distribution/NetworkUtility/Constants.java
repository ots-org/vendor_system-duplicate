package com.ortusolis.water_distribution.NetworkUtility;
...
public class Constants {
    ...
    static String baseUrl = "http://ec2-13-232-112-42.ap-south-1.compute.amazonaws.com:8080/ots/api/v18_1/";
