...
package com.ortusolis.water_distribution.cropper;
...
public final class CropImage {
    ...
    public static final class ActivityBuilder {
        ...
        public void start(@NonNull Fragment fragment, Activity activity) {
            mOptions.validate();
            fragment.startActivityForResult(getIntent(activity), CROP_IMAGE_ACTIVITY_REQUEST_CODE);
        }
