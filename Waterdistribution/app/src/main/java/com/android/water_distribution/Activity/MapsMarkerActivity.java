...
import com.android.water_distribution.pojo.EmpLatLon;
    ...
    void getMapLocation(String userId){
        ...
        wss.postLoginVolley(Constants.getEmpLatLong, requestObject.toString(), new IResult() {
            ...
            public void notifyError(VolleyError error) {
                ...
                finish();
                Toast.makeText(MapsMarkerActivity.this, WebserviceController.returnErrorMessage(error) + "", Toast.LENGTH_SHORT).show();
            }
        });
    }
