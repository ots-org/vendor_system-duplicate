    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                final TextView deliveryEdit = view1.findViewById(R.id.deliveryEditText);
                final TextView canRecievedEditText = view1.findViewById(R.id.canRecievedEditText);
                ...
                canRecievedEditText.setText(item.getCanRecieved()!=null ? item.getCanRecieved() : "0");
                ...
                balanceCanEdit.setText(balanceCan+"");
                ...
                updateButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (Integer.valueOf(balanceCanEdit.getText().toString())>=0) {
                            ...
                            Toast.makeText(AssignedVoucherOrderDescription.this, "Balance Can cannot be Negative", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
        ...
        createSaleVoucher.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Integer balanceAmount = (Integer.valueOf(TextUtils.isEmpty(outstandingAmt.getText().toString())?"0":outstandingAmt.getText().toString()) + Integer.valueOf(TextUtils.isEmpty(orderCostEditText.getText().toString())?"0":orderCostEditText.getText().toString()))
                                        -Integer.valueOf(TextUtils.isEmpty(amountRecievedEditText.getText().toString())|| amountRecievedEditText.getText().toString().equalsIgnoreCase("-")?"0": amountRecievedEditText.getText().toString());
                balanceAmountEditText.setText(balanceAmount+"");
                ...
                closeOrderButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                    alertDialog.dismiss();
                    closeOrder(balanceAmountEditText.getText().toString(),orderCostEditText.getText().toString(), amountRecievedEditText.getText().toString().equalsIgnoreCase("-") ? "0":amountRecievedEditText.getText().toString(),buttonDatePick.getText().toString());
                    }
                });
                alertDialog.show();
            }
    ...
    void closeOrder(String outstandingAmt, String orderCost, String amountReceived,String dateStr){
            ...
            wss.postLoginVolley(Constants.saleVoucher, requestObject.toString(), new IResult() {
                ...
                public void notifySuccess(String response, int statusCode) {
                    try {
                        ...
                        if (responseData.getResponseCode().equalsIgnoreCase("200")) {
                            ...
                            setResult(RESULT_OK);
                            finish();
                            Toast.makeText(AssignedVoucherOrderDescription.this, TextUtils.isEmpty(responseData.getResponseDescription()) ? " " : responseData.getResponseDescription(), Toast.LENGTH_SHORT).show();
                        } else
                            Toast.makeText(AssignedVoucherOrderDescription.this, TextUtils.isEmpty(responseData.getResponseDescription()) ? "Failed to assign" : responseData.getResponseDescription(), Toast.LENGTH_SHORT).show();
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
                ...
                public void notifyError(VolleyError error) {
                    ...
                    Toast.makeText(AssignedVoucherOrderDescription.this, WebserviceController.returnErrorMessage(error) + "", Toast.LENGTH_SHORT).show();
                }
            });
    }
                ...
                try {
                    ...
                    if (distributorResponse.getResponseCode().equalsIgnoreCase("200")) {
                        ...
                        if (distributorResponse.getResponseData().getUserDetails().isEmpty()){
                            Toast.makeText(AssignedVoucherOrderDescription.this, "No Results", Toast.LENGTH_SHORT).show();
                        }
