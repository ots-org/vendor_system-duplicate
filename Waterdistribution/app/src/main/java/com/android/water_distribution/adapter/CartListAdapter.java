...
import com.android.water_distribution.Activity.CardListActivity;
...
public class CartListAdapter extends RecyclerView.Adapter<CartListAdapter.ModuleViewHolder> {
    ...
    public void onBindViewHolder(final ModuleViewHolder holder, final int position) {
        ...
        if (position%2==0){
            holder.picture.setImageResource(R.drawable.water1);

        }
        else {
            holder.picture.setImageResource(R.drawable.water2);
        }
