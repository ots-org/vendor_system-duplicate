...
import com.android.water_distribution.pojo.BillReportModel;
import com.android.water_distribution.pojo.BillReportResponse;
import com.android.water_distribution.pojo.BillRequest;
...
public class BillDescription extends AppCompatActivity {
    ...
    void addOrUpdateCustomerOutstandingAmt(){
            ...
            wss.postLoginVolley(Constants.addOrUpdateCustomerOutstandingAmt, requestObject.toString(), new IResult() {
                ...
                public void notifySuccess(String response, int statusCode) {
                    try {
                        ...
                        if (responseData.getResponseCode().equalsIgnoreCase("200")) {
                            ...
                            Toast.makeText(BillDescription.this, TextUtils.isEmpty(responseData.getResponseDescription()) ? "Failed to assign" : responseData.getResponseDescription(), Toast.LENGTH_SHORT).show();
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
                ...
                public void notifyError(VolleyError error) {
                    ...
                    prog();
                    Toast.makeText(BillDescription.this, WebserviceController.returnErrorMessage(error) + "", Toast.LENGTH_SHORT).show();
                }
            });
                ...
                public void notifySuccess(String response, int statusCode) {
                    try {
                        ...
                        if (responseData.getResponseCode().equalsIgnoreCase("200")) {
                            ...
                            Toast.makeText(BillDescription.this, TextUtils.isEmpty(responseData.getResponseDescription()) ? "Failed to generate Bill" : responseData.getResponseDescription(), Toast.LENGTH_SHORT).show();
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
    ...
    void addRow(ProductDetails productDetails){
        ...
        if (productDetails!=null){
                ...
                int totalAmt = Integer.valueOf(productDetails.getProductPrice()) * Integer.valueOf(productDetails.getProductqty());
