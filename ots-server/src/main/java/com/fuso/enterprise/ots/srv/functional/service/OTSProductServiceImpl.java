	...
	public GetProductStockListBOResponse getProductStockList(GetProductStockListRequest getProductStockListRequest) {
		...
		try {
			...
			for (ProductDetails productDetailItem: otsProductList) {
				 ...
				 */
				try {
					ProductStockDetail.setOtsProductOrderDelivered(orderProductDAO.getProductStock(getProductStockListRequest.getRequestData().getTodaysDate(), Integer.parseInt(productDetailItem.getProductId()), Integer.parseInt(getProductStockListRequest.getRequestData().getUserId())));
...
//					ProductStockDetail.setOtsProductOrderDelivered(Integer.parseInt(productDetailItem.getProductId()));
//				else
//					ProductStockDetail.setOtsProductOrderDelivered(0);
