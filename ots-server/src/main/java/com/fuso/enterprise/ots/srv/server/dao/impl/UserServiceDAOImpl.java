...
//	   		userDetails.getCustomerProductDetails().add(i,tempcustomerProductDetails);
	...
	@Override
	public List<Map<String, Object>> getSellerDetails(GetSellerByLatAndLonRequest getSellerByLatAndLonRequest) {
		Map<String, Object> inParamMap = new HashMap<String, Object>();	
		
		inParamMap.put("userLongitude", getSellerByLatAndLonRequest.getRequest().getLongitude());
		inParamMap.put("userLatitude",  getSellerByLatAndLonRequest.getRequest().getLatitude());
		inParamMap.put("distance", getSellerByLatAndLonRequest.getRequest().getDistance());
		
		SimpleJdbcCall simpleJdbcCall = new SimpleJdbcCall(jdbcTemplate)
				.withProcedureName("find_nearest_seller")
		...
		simpleJdbcCall.addDeclaredParameter(new SqlParameter("distance", Types.INTEGER));
