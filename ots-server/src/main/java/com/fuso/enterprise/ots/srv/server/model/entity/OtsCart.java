...
public class OtsCart implements Serializable {
    ...
    @JoinColumn(name = "ots_distributor", referencedColumnName = "ots_users_id")
    @ManyToOne(optional = false)
    private OtsUsers otsDistributor;
    ...
    public OtsUsers getOtsDistributor() {
        return otsDistributor;
    }

    public void setOtsDistributor(OtsUsers otsDistributor) {
        this.otsDistributor = otsDistributor;
    }
