...
@NamedQueries({
    ...
    , @NamedQuery(name = "OtsOrderProduct.findByOtsProductDeliverdDate", query = "SELECT o FROM OtsOrderProduct o WHERE o.otsProductDeliverdDate = :otsProductDeliverdDate")})
public class OtsOrderProduct implements Serializable {
    ...
    @Column(name = "ots_product_deliverd_date")
    @Temporal(TemporalType.DATE)
    private Date otsProductDeliverdDate;
    ...
    public Date getOtsProductDeliverdDate() {
        return otsProductDeliverdDate;
    }

    public void setOtsProductDeliverdDate(Date otsProductDeliverdDate) {
        this.otsProductDeliverdDate = otsProductDeliverdDate;
    }
