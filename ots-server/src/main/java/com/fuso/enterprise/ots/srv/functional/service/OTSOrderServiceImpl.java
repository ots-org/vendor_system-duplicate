...
//	}
	...
	@Override
	public List<OrderProductDetails> getUserByStatuesAndDistributorId(
			GetOrderForFacilitatorRequest getOrderForFacilitatorRequest) {
		List<OrderProductDetails> orderProductList = orderProductDao.getUserByStatuesAndDistributorId(getOrderForFacilitatorRequest);
		for(int i=0;i<orderProductList.size() ;i++ ) {
			orderProductList.get(i).setOrderDetails(orderServiceDAO.GetOrderDetailsByOrderId(orderProductList.get(i).getOtsOrderId()));
		}
	...
	public String updateOrderdProductStatus(UpdateOrderdProductRequest updateOrderdProductRequest) {
		// TODO Auto-generated method stub
		return orderProductDao.updateOrderdProductStatus(updateOrderdProductRequest);
	}
}
