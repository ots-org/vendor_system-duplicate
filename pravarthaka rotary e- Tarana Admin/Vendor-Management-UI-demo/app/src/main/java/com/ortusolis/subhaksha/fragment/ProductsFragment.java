...
import com.ortusolis.subhaksha.adapter.AdapterCatagoryLIst;
import com.ortusolis.subhaksha.adapter.CategoryAdapter;
import com.ortusolis.subhaksha.adapter.WaterCanAdapter;
...
public class ProductsFragment extends Fragment {
   ...
   // Adapter adapter1;
    ...
    ListView listView;
    ListView list;
    String[] Catrgorylist  = new String[50];;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Catrgorylist[0] = "https://homepages.cae.wisc.edu/~ece533/images/airplane.png";
        Catrgorylist[1] = "https://homepages.cae.wisc.edu/~ece533/images/airplane.png";
        Catrgorylist[2] = "https://homepages.cae.wisc.edu/~ece533/images/airplane.png";
        Catrgorylist[3] = "https://homepages.cae.wisc.edu/~ece533/images/airplane.png";
        Catrgorylist[4] = "https://homepages.cae.wisc.edu/~ece533/images/airplane.png";
     //   listView=(ListView)view.findViewById(R.id.listView);
        recyclerView=view.findViewById(R.id.recyclerviewCat);

        final AdapterCatagoryLIst adapter=new AdapterCatagoryLIst(getActivity(), Catrgorylist);
...
////            getProducts();
//            if (sharedPreferences.contains("categoryIdClicked") && !sharedPreferences.getString("categoryIdClicked","").equalsIgnoreCase("")) {
//
//                ProductOnSelectCategory(sharedPreferences.getString("categoryIdClicked",""));
//            }else {
//                getProductsMain();
//            }
...
//        }
       ...
       /* recyclerView
                ...
                R.id.recyclerview);*/
    //    imageListView=view.findViewById(R.id.listView);
...
//        source.add("https://homepages.cae.wisc.edu/~ece533/images/airplane.png");
       /* source.add("Grocery");
        source.add("Home made products");
        source.add("Home made snaks & sweets");
        source.add("Health Drink Mix");
        source.add("Products in the pipeline");*/
                ...
                try {
                    ...
                    if (obj.getString("responseCode").equalsIgnoreCase("200")) {
                        ...
                        for (int ProdCategory=0;ProdCategory<productDetails.length();ProdCategory++){
                            ...
                            productCatagoryNames.add(productDetailsobject.getString("productName"));
                            productCatagoryIdList.add(productDetailsobject.getString("productId"));
                            source.add(productDetailsobject.getString("productImage"));
                        }

                        CategoryAdapter categoryAdapter= new CategoryAdapter(getContext(),source,productCatagoryIdList);
                        recyclerView.setAdapter(categoryAdapter);
                           /* recyclerView.addOnItemTouchListener(View.)
                                @Override
                                public void onClick(View v) {
                                    Toast.makeText(getActivity(), "clicked", Toast.LENGTH_LONG).show();
                                }
...
//                progressDialog.dismiss();
    ...
    public void ProductOnSelectCategory(String productID) {
//        progressDialog = new ProgressDialog(getActivity());
//        progressDialog.setMessage("Loading...");
//        progressDialog.setCancelable(false);
//        progressDialog.show();
        ...
        try {
            jsonObject.put("searchKey", "pagination");
            jsonObject.put("searchvalue", productID);
            jsonObject.put("distributorId", "string");
            jsonObject.put("customerId", "string");
            jsonObject.put("status", "active");
            jsonObject.put("maxRange", "string");
            jsonObject.put("minRange", "string");
            jsonObject.put("productId", "string");
            jsonObject.put("size", "1000");
            jsonObject.put("startOn", "1");
            jsonObject.put("procedureKey", "category");
            ...
            public void notifySuccess(String response, int statusCode) {
                ...
                try {
                    ...
                    if (responseData.getResponseCode().equalsIgnoreCase("200")) {
                        ...
                        sharedPreferences.edit().putString("categoryIdClicked","").commit();
//                        gridview.removeAllViews();
//                        waterCanAdapter.notifyDataSetInvalidated();
                        waterCanAdapter = new WaterCanAdapter(getActivity(),responseData.getResponseData().getProductDetails(),ProductsFragment.this);
                        waterCanAdapter.notifyDataSetChanged();
