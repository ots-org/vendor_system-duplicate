...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String[] strOpts = {"Register as Facilitator", "Register as an Partner"}; //, "Register as an admin" "Register as Donor",
                int checkedItem = 0;
                strName = strOpts[0];
    ...
    boolean isValid(){
        if (enterUsername.getText().toString().isEmpty() || enterPassword.getText().toString().isEmpty() || enterUsername.getText().toString().length()!=10){
            return false;
        }
        return true;
    }
    ...
    void login(){
        ...
        wss.postLoginVolley(Constants.LOGIN_API, requestObject.toString(), new IResult() {
            ...
            public void notifySuccess(String response, int statusCode) {
                try {
                    ...
                    if (responseData.getResponseCode().equalsIgnoreCase("200")) {
                        ...
                        if(responseData.getResponseData().getUserDetails().getUserRoleId().equals("5") ||responseData.getResponseData().getUserDetails().getUserRoleId().equals("4")){
            ...
            public void notifyError(VolleyError error) {
                ...
                Toast.makeText(LoginActivity.this, "please check the network connection & Try Again", Toast.LENGTH_LONG).show();
            }
        });
    }
