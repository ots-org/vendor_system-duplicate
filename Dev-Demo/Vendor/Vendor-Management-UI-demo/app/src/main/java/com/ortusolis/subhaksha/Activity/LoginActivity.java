...
public class LoginActivity extends AppCompatActivity{
    ...
    //
    TextView register,forgotPassword,lang,ortusolis;
    Button login;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ortusolis  = findViewById(R.id.ortusolis);
        gson = new Gson();
        ...
        ortusolis.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent Email = new Intent(Intent.ACTION_SEND);
                Email.setType("message/rfc822");
                Email.setPackage("com.google.android.gm");
                Email.putExtra(Intent.EXTRA_EMAIL, new String[] {"shachi.yelandur@ortusolis.com"});
                Email.putExtra(Intent.EXTRA_SUBJECT, "Feedback Ortusolis");
