...
public class ProductsFragment extends Fragment {
    ...
    void getProducts(){
        final ProgressDialog progressDialogProduct;
        progressDialogProduct = new ProgressDialog(getContext());
        progressDialogProduct.setMessage("Please Wait ...");
        progressDialogProduct.setIndeterminate(false);
        progressDialogProduct.setCancelable(false);
        progressDialogProduct.show();
         distributorId =(sharedPreferences.getString("userRoleId","").equalsIgnoreCase("2") || sharedPreferences.getString("userRoleId","").equalsIgnoreCase("1")) ? sharedPreferences.getString("userid","") : sharedPreferences.getString("distId","");
