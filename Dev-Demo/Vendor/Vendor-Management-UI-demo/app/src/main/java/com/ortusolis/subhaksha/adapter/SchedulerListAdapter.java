...
import com.ortusolis.subhaksha.pojo.SchedulerModel;
...
//code change by ortusolis- raghu
        ...
        holder.productPrice.setText(Html.fromHtml("<b>Product Price: </b>"+context.getString(R.string.Rs)+item.getProductDetails().getProductPrice()));
