...
public class ProductRequest {
    ...
    ArrayList<ProductOrder> productList;
        ...
        public String getRzpyTransactionId() {
            return rzpyTransactionId;
        }

        public void setRzpyTransactionId(String rzpyTransactionId) {
            this.rzpyTransactionId = rzpyTransactionId;
        }
