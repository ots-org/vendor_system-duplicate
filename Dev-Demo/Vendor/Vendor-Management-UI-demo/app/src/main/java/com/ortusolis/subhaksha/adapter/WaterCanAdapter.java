...
import com.ortusolis.subhaksha.Activity.ProductDescription;
...
//        }
        ...
        View.OnClickListener onClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (sharedPreferences.contains("userRoleId") && (sharedPreferences.getString("userRoleId","").equalsIgnoreCase("1")||sharedPreferences.getString("userRoleId","").equalsIgnoreCase("2"))){

                }
                else {
//                    String stockStatus=mData.get(position).getStock();
//                    if(stockStatus.equalsIgnoreCase("no")){
//                        buyNow.setEnabled(false);
//                        Toast.makeText(context,"Available Stock " +mData.get(position).getStock() , Toast.LENGTH_LONG).show();
//                        return;
//                    }
        ...
        if (context.getSharedPreferences("water_management", 0).getString("userRoleId", "").equalsIgnoreCase("2")) {
            scheduleButton.setVisibility(View.GONE); // changing visible to gone
            buyNow.setVisibility(View.GONE); // changing visible to gone
        } else {
